  ...
  return (
    <main className='bg-zinc-50'>
      ...
      <section className='flex justify-center'>
        <div className='search max-w-screen-2xl w-full flex flex-col items-center gap-4 py-20 px-8 sm:px-16 md:px-24 lg:px-40 xl:px-48'>
      ...
      <section className='flex justify-center'>
        <div className=' max-w-screen-2xl grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 lg:gap-10 bg-zinc-50 w-full pb-8 px-8 sm:px-16 md:px-24 lg:px-40 xl:px-48'>
