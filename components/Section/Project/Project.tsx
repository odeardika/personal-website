...
export default function Project() {
  ...
  return (
    ...
    data-aos="fade-up" 
    id='project-section' 
    className='flex flex-col items-center justify-center gap-8 py-24 bg-zinc-50 scroll-mt-24'>
        <div className="max-w-screen-2xl mx-auto w-full">
            <div className='flex flex-col gap-2 md:gap-6 items-center'>
                <h2 className='font-semibold text-2xl md:text-4xl lg:text-5xl text-dark_blue'>My Project</h2>
                <p className='text-dark_blue/50 font-light text-xs md:text-base lg:text-xl'>My latest project</p>
            </div>

            <div className='grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 lg:gap-10 px-10 lg:px-48 xl:px-48 mt-8 md:py-4'>
