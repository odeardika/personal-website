  ...
  return (
    ...
    >
      <div className='absolute flex-grow w-full h-full z-0 flex items-end justify-center overflow-hidden'>
        <Image src={'/assets/images/about_img.png'} className='h-[90%] w-auto object-cover' width={200} height={200} alt='background`s image' />
      </div>
      <div className="max-w-screen-2xl mx-auto px-10 md:px-24 lg:px-48 w-full z-10 flex flex-col py-24">
        <div className='flex flex-col items-center'>
          <div className='bg-white flex flex-col gap-2 md:gap-4 items-center p-4 rounded-lg shadow-lg'>
        ...
        <div className='flex mt-4 flex-col md:flex-row gap-4 justify-end md:gap-16'>
          <div className='flex flex-col gap-5 md:gap-10 items-center md:items-start w-[100%] md:w-[55%] lg:w-[53%] justify-between h-full md:py-16'>
            ...
            <div className='flex flex-col gap-3 bg-white rounded-lg shadow-lg p-4'>
